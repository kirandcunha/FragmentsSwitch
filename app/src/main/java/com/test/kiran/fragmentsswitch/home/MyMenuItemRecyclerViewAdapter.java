 ...
 * specified {@link MenuItemFragment.OnListFragmentInteractionListener}.
...
public class MyMenuItemRecyclerViewAdapter extends RecyclerView.Adapter<MyMenuItemRecyclerViewAdapter.ViewHolder> {
    ...
    private final MenuItemFragment.OnListFragmentInteractionListener mListener;

    public MyMenuItemRecyclerViewAdapter(List<DummyItem> items, MenuItemFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
